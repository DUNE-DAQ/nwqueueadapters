...
def cli(producer_host, consumer1_host, consumer2_host, json_dir):
    """
      JSON_DIR: Json file output folder
    """
    console.log("Loading fake_data_producer config generator")
    from . import fake_data_producer_gen
    console.log("Loading fake_data_consumer config generator")
    from . import fake_data_consumer_gen
    console.log(f"Generating configs")

    network_endpoints={
        "fake_data" : "tcp://{host_producer}:12344",
    }
    
    cmd_data_producer = fake_data_producer_gen.generate(
        NETWORK_ENDPOINTS = network_endpoints
    )

    cmd_data_consumer1 = fake_data_consumer_gen.generate(
        NETWORK_ENDPOINTS = network_endpoints
    )

    cmd_data_consumer2 = fake_data_consumer_gen.generate(
        NETWORK_ENDPOINTS = network_endpoints
    )
    ...
    app_producer="fake_data_producer"
    app_consumer1="fake_data_consumer1"
    app_consumer2="fake_data_consumer2"
